...
public:
    explicit MyMode(auterion::SDK& sdk, auterion::multicopter::GotoControlLimits& limits,
        ...
        _mode.onActivate([this]() {
            std::cout << "Cargo Mode activated. Grupo1!!!" << std::endl;
        ...
        _mode.onUpdateSetpoint([this](float dt_s) -> auterion::Setpoint {
            ...
            switch (_state) {
                ...
                case State::GoingPos1: {
                    ...
                    const float goal_heading_enu_rad = M_PI / 2.F;  // EAST
                ...
                case State::GoingPos2: {
                    ...
                    const float goal_heading_enu_rad = 3.F * M_PI / 4.F;  // North-EAST
                ...
                case State::GoingPos5: {
                    const Eigen::Vector3f goal_position_enu_m{-6.F, 0.F, 5.F};
                    const float goal_heading_enu_rad = M_PI / 2.F;  // WEST
...
int main(int argc, char* argv[]) {
 ...
 // Define speed limits while reaching goto setpoints
    const float max_horizontal_speed_m_s{1.F};
    ...
    const float position_error_threshold_m{0.8F};
