...
#include <fstream>
    ...
    // TODO #1: define your global variables here//DONE
    class MyMode {
   private:
    auterion::Mode _mode;
    ...
    enum class State { GoingToStart = 0, GoingPos1, GoingPos2, GoingPos3 } _state;
            ...
            switch (_state) {
                ...
                case State::GoingPos2: {
                 ...
                 case State::GoingPos3: {
                    const Eigen::Vector3f goal_position_enu_m{-30.F, 30.F, 5.F};
                    const float goal_heading_enu_rad = -10.F * M_PI / 4.F;  // South-west
...
int main(int argc, char* argv[]) {
 ...
 const float max_horizontal_speed_m_s{3.F};
    const float max_vertical_speed_m_s{2.F};
    const float max_heading_rate_rad_s{0.8F};
