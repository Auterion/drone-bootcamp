        ...
        _mode.onUpdateSetpoint([this](float dt_s) -> auterion::Setpoint {
            ...
            switch (_state) {
                ...
                case State::GoingPos1: {
                    ...
                    const float goal_heading_enu_rad =0;  // East
                ...
                case State::GoingPos2: {
                    const Eigen::Vector3f goal_position_enu_m{10.F, 12.F, 5.F};
                ...
                case State::GoingPos3: {
                    const Eigen::Vector3f goal_position_enu_m{0.F, 12.F, 5.F};
                ...
                case State::GoingPos4: {
                    const Eigen::Vector3f goal_position_enu_m{-10.F, 12.F, 5.F};
                    const float goal_heading_enu_rad = 3*M_PI / 2.F;  // North West
                ...
                case State::GoingPos5: {
                    const Eigen::Vector3f goal_position_enu_m{-10.F, 0.F, 5.F};
                    const float goal_heading_enu_rad = M_PI / 1.F;  // West
